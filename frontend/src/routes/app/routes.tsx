...
export function PurchasesPage({ getToken, onNavigate }: TokenNavigateProps): ReactElement {
...
export function SubscriptionsPage({ getToken, onNavigate }: TokenNavigateProps): ReactElement {
...
export function DownloadsPage({ getToken, onNavigate }: TokenNavigateProps): ReactElement {
...
export function BookingsPage({ getToken, onNavigate }: TokenNavigateProps): ReactElement {
